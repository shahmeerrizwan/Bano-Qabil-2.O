            ...
            <div className='flex cont'>
                ...
                <div className='mid'>
                    ...
                    <div className=' mid-1 flex margin border'>
                        ...
                        <p className='cl'>is ppp going to join cabinet? <br />
                            Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quibusdam odio quisquam maiores sed illo pariatur magni tempore, vero blanditiis aspernatur.</p>
                    </div>
                    <div className=' mid-1 flex margin  border'>
